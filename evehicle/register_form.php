...
<div class="container">
	...
	<div class="header">
		...
		<center><b>User Registration</b></center>
	</div>
	...
	<div align="center">
		...
		<form method="post" action="approvedEmail1.php">
			<div class="input">
				<label style="font-weight: normal; font-size: 13px;">Please enter your Staff ID and I/C number to register your ticket for eVehicle.</label>
			</div>
			<div class="input">
