                ...
                <div class="form">
					...
					<div class="form">
						<label><b>Full Name :</b></label>
				  		<input type="text" name="name" value="<?php echo "$row[Staff_Name]"?>">
					</div>

					<div class="form">
						<label><b>Department :</b></label>
                        <input type="text" name="dept" value="<?php echo "$row[Staff_Dept]"?>">
					</div>
					
					<div class="form">
						<label><b>Position :</b></label>
				  		<input type="text" name="post" value="<?php echo "$row[Staff_Position]"?>">		  		
					</div>

					
					<div class="form">
						<label><b>Phone Number :</b></label>
				  		<input type="text" name="phone" value="<?php echo "$row[Staff_Phone]"?>">
					</div>

					<div class="form">
						<label><b> Phone Extension Number :</b></label>
				  		<input type="text" name="ext" value="<?php echo "$row[Staff_Extension]"?>">
					</div>

					<div class="form">
						<label><b>Email Address :</b></label>
				  		<input type="text" name="email" value="<?php echo "$row[Staff_Email]"?>">
					</div>

					<div class="form">
						<label><b>Password :</b></label>
				  		<input type="password" id="katalaluan" name="password" value="<?php echo "$row[Staff_Password]"?>">
