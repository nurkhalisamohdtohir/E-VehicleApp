				...
				<form role="form" action="update_booking.php" method="post" name="form" id="form" onsubmit="return save()" >
					...
					<div class="form">
						<div class="tarikh-pergi">
							...
							<input type="date" name="dateFrom" id="dateFrom" value="<?php echo $row['Date_Out']?>" readonly>
						...
						<div class="tarikh-balik">
							...
							<input type="hidden" id="date2" value="<?php echo $row['Date_In']?>">
				  			<input type="date" name="dateTo" id="dateTo" value="<?php echo $row['Date_In']?>" readonly><br>
				  		</div>
					</div>
					...
					<div class="form">
						<div class="masa-pergi">
							<label><b>Departure Time : </b></label><br>
				  			<input type="time" name="timeFrom" id="timeFrom" value="<?php echo $row['Time_Out']?>" readonly>
						</div>

						<div class="masa-balik">
							<label><b>Return Time : </b></label><br>
				  			<input type="time"  name="timeTo" id="timeTo" value="<?php echo $row['Time_In']?>" readonly><br>
						</div>
					</div>

					<div class="form">
						<label><b>Destination : </b></label>
				  		<input type="text" name="dest" id="dest" value="<?php echo $row['Destination']; ?>" style="text-transform:uppercase" readonly >
					</div>

					<div class="form">
						<label><b>Reason :</b></label>
				  		<input type="text" name="reason" id="reason" value="<?php echo $row['Reason']; ?>" style="text-transform:uppercase" readonly >
					</div>
			...
			<div class="form-right">
				 -->
					...
					<div class="form">
						...
						<div class="bil-kend">
							<label><b>Preference of Vehicle Type :</b></label><br>
				  			<input type="Number" class="num_passenger" id="num_psg" name="num_psg" value="<?php echo $row['Cat_Name']; ?>" readonly/>
						</div>
					</div>
					...
					<div class="view-booking-button"> 
						<button type="reset" class="btn" onclick="window.location.href = 'booking_history.php';">Back</button>
					</div>
