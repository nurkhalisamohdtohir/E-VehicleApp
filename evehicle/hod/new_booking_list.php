    ...
    <div class="title">
		...
		<div class="div-table">
            <table class= "table-semak">
				...
				$counter = 1;
				$sql="SELECT * FROM booking INNER JOIN user ON booking.Staff_ID = user.Staff_ID INNER JOIN trip ON booking.Book_No = trip.Book_No WHERE Book_Status = 'ACCEPTED' GROUP BY trip.Book_No ORDER BY booking.Book_Date ";
                ...
                <tr class="tbody">
					...
					<td><a href="view_new_vehicle.php?id=<?php echo $row1['Book_No'];?>" class="a-icon"><i class="fa fa-arrow-right w3-large"></i></a></td>
				</tr>
					<?php
						$counter++;
					} 
