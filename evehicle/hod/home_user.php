...
<content>
    <center>
        ...
        <div class="row">
            ...
            <br>
            <div class="title">
            <h2><b>Booking Approval Request</b></h2><hr>
            </div>

            <div class="purplecard">
                <a href="new_booking_list.php">
                    <div class="purplecard-up">
                        <div class="purplecard-number">
                            <div>
                                <?php  
                                    $sql="SELECT COUNT(DISTINCT trip.Book_No) AS total FROM trip INNER JOIN booking ON trip.Book_No = booking.Book_No WHERE Book_Status = 'ACCEPTED' ";
                        ...
                        <div class="purplecard-text">
                            BOOKING APPLICATION
                        </div>
                    </div>
                    <div class="purplecard-down">
                        <div class="purplecard-text-down">
                            See More
                        </div>
                        <div class="purplecard-icon-down">
                            <i class="w3-margin-left fa fa-arrow-right"></i>
                        </div>
                    </div> 
                </a>
